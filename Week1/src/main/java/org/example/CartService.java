...
public class CartService {
    public static void saveCart(int totalItems, double totalCost, String language,
        ...
        saveCart(totalItems, totalCost, language, items, DatabaseConnection::getConnection);
    }

    static void saveCart(int totalItems, double totalCost, String language,
                         List<ShoppingCart.Item> items, SqlConnectionSupplier connectionSupplier) {
